 ...
 * 
 * v1.1.0, 15.07.2026                                 Автор:      Труфанов В.Е.
...
char chi[] = "Число = ";
char line[][smLINESIZE] =   // буфер всех сообщений экрана дисплея
{
  "Text",
  "Привет Hello world",
  "Line 2",
...
class TSprite_Main 
{
  ...
  char fill[smLINESIZE];        // заполнитель строки
  char chi[10] = "Chislo = ";
  char line[13][smLINESIZE] =   // буфер всех сообщений экрана дисплея
  {
    "Text",
    "Привет Hello world",
    "Line 2",
...
TSprite_Main::TSprite_Main(TFT_eSPI tftIn) 
{
  TFT_eSPI tft = tftIn;
