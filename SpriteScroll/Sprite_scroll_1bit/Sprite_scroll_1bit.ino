...
void setup() {
  ...
  stext3.createSprite(160, 160);
  stext3.fillSprite(TFT_DARKGREY);
  //stext3.setScrollRect(0, 0, 80, 80, TFT_DARKGREY); // Scroll in the first 80 pixels
  stext3.setTextColor(TFT_WHITE); // White text, no background
  //stext3.loadFont("HuaweiSans16");     // загрузка в память шрифта
  stext3.loadFont("nasalization48");     // загрузка в память шрифта
...
void loop() 
{
  ...
  { // If we have scrolled 40 pixels the redraw text
    ...
    // Ниже складываем прежнее значение
    //stext3.setCursor(0,12);
    stext3.setCursor(0,38);
    //stext3.print("Число = "); 
    stext3.print("Чи="); 
    stext3.print(i); stext3.println("!");
    ...
    //stext3.print("Число = "); 
    stext3.print("Чи="); 
    stext3.print(i); stext3.print("!");

    delay(500); // иммитировали перетекание
    stext3.pushSprite(40, 90);
  }
