...
void setup() 
{
  ...
  stext3.createSprite(80, 40);
  stext3.fillSprite(TFT_DARKGREY);
  //stext3.setScrollRect(0, 0, 40, 40, TFT_DARKGREY); // Scroll the "Hello" in the first 40 pixels
...
void loop() 
{
  ...
  //stext3.scroll(0,1);     // ---scroll stext 1 pixel right, up/down default is 0
  ...
  { // If we have scrolled 40 pixels the redraw text
    ...
    //stext3.loadFont("HuaweiSans16");     // загрузка в память шрифта
    //stext3.setTextColor(TFT_ORANGE, TFT_BLACK);
    stext3.setCursor(0,0);
    stext3.print("Число = "); stext3.print(i); stext3.print("!");
    i++;
    stext3.setCursor(0,12);
    stext3.print("Число = "); stext3.print(i); stext3.println("!");
    //stext3.unloadFont();                 // выгрузка шрифта из памяти
    

    /*
    stext3.fillSprite(TFT_BLACK);    // заливка фона чёрным цветом
    //tft.setRotation(nRotat);      // вращение
    stext3.setTextSize(2);           // размер текста - №2
    stext3.setTextWrap(false, false);
    ...
    */
    ...
    //stext3.drawString("Help Me", 6, 0, 2); // draw at 6,0 in sprite, font 2
  }
